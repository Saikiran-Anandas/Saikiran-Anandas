...
#title of the window
root.title("Message Encode and Decode..@Saikiran_Anandas")
...
#label
Label(root, text ='ENCODE DECODE', font = 'arial 20 bold', bg="#FEE873").pack()
Label(root, text ='@Saikiran-Anandas', font = 'arial 20 bold', bg="#FEE873").pack(side =BOTTOM)
